...
| 🧰 | [**claude-code-skills**](https://github.com/0xmortuex/claude-code-skills) | A curated pack of Claude Code skills for the unglamorous work that ships software — every new skill researched against the existing ecosystem first, so each one solves a problem no prominent skill covers |
